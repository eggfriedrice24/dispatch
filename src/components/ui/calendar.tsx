...
export function Calendar({
  ...
  const defaultClassNames = {
    ...
    day_button: cn(
      buttonClassNames,
      "in-[.range-middle]:in-data-selected:bg-accent in-data-selected:bg-primary in-[.range-middle]:in-data-selected:text-foreground in-data-disabled:text-muted-foreground/70 in-data-outside:text-muted-foreground/70 in-data-selected:in-data-outside:text-primary-foreground in-data-selected:text-primary-foreground focus-visible:ring-ring/50 outline-none focus-visible:z-1 focus-visible:ring-[3px] in-data-disabled:pointer-events-none in-data-disabled:line-through in-[.range-end:not(.range-start)]:rounded-s-none in-[.range-middle]:rounded-none in-[.range-start:not(.range-end)]:rounded-e-none in-[[data-selected]:not(.range-middle)]:transition-[color,background-color,border-radius,box-shadow]",
    ),
